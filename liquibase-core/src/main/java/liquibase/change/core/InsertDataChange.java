...
public class InsertDataChange extends AbstractChange implements ChangeWithColumns<ColumnConfig>, DbmsTargetedChange {
    ...
    public SqlStatement[] generateStatements(Database database) {
        ...
        if (needsPreparedStatement) {
            return new SqlStatement[] { new InsertExecutablePreparedStatement(database, catalogName, schemaName, tableName, columns, getChangeSet(),
                    this.getResourceAccessor()) };
        }
    ...
    protected Change[] createInverses() {
        ...
        DeleteDataChange inverse = new DeleteDataChange();
